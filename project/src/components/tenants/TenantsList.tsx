            ...
            {filteredTenants.length > 0 ? (
              filteredTenants.map((tenant) => (
                <tr key={tenant.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-gray-900">Kamar {tenant.roomId}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-gray-500 text-sm">sampai {formatDate(tenant.endDate)}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <Badge className={getPaymentStatusColor(tenant.paymentStatus)}>
                      {tenant.paymentStatus === 'paid' ? 'Lunas' :
                       tenant.paymentStatus === 'pending' ? 'Menunggu' : 'Terlambat'}
                    </Badge>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
